package com.somnus.androidpikerview;
...
import com.somnus.androidpikerview.bean.ProvinceBean;
import com.somnus.pikerviewlib.OptionsPickerView;
import com.somnus.pikerviewlib.TimePickerView;
...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 选项1
		options1Items
				.add(new ProvinceBean(0, "广东", "广东省，以岭南东道、广南东路得名", "其他数据"));
		options1Items.add(new ProvinceBean(1, "湖南",
				"湖南省地处中国中部、长江中游，因大部分区域处于洞庭湖以南而得名湖南", "芒果TV"));
