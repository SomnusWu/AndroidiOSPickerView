package com.somnus.pikerviewlib.lib;
...
import com.somnus.pikerviewlib.R;
import com.somnus.pikerviewlib.adapter.WheelAdapter;
import com.somnus.pikerviewlib.listener.OnItemSelectedListener;
...
public class WheelView extends View {
	...
	private void remeasure() {
		...
		// 计算两条横线和控件中间点的Y位置
		firstLineY = (int) ((measuredHeight - lineSpacingMultiplier
				* maxTextHeight) / 2.0F);
		secondLineY = (int) ((measuredHeight + lineSpacingMultiplier
				* maxTextHeight) / 2.0F);
	...
	protected void onDraw(Canvas canvas) {
		...
		while (counter < itemsVisible) {
			...
			if (angle >= 90F || angle <= -90F) {
				...
				int translateY = (int) (radius - Math.cos(radian) * radius - (Math
